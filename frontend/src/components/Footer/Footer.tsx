    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        <div className={styles.section}>
          <h3>ADJOURNMENT.AI</h3>
          <p>Redefining legal research and simulation through artificial intelligence.</p>
        ...
        <div className={styles.section}>
          <h4>Quick Links</h4>
          <ul>
            <li><a href="/cases">Simulator</a></li>
            <li><a href="/judgementsearch">Judgment Search</a></li>
        ...
        <div className={styles.section}>
          <h4>Contact</h4>
          <div className={styles.contactItem}><IconMail size={16} /> support@adjournment.ai</div>
          <div className={styles.contactItem}><IconPhone size={16} /> +91-XXX-XXXX-XXX</div>
          <div className={styles.contactItem}><IconMapPin size={16} /> New Delhi, India</div>
        </div>
      </div>
      <div className={styles.bottom}>
        <p>© {new Date().getFullYear()} Adjournment.ai · All Rights Reserved</p>
      </div>
    </footer>
  );
};
