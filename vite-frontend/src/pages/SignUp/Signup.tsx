...
const UniversityIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    <polygon points="22,8 12,2 2,8 12,14"/><line x1="6" y1="10" x2="6" y2="18"/><line x1="10" y1="10" x2="10" y2="18"/><line x1="14" y1="10" x2="14" y2="18"/><line x1="18" y1="10" x2="18" y2="18"/><line x1="2" y1="18" x2="22" y2="18"/>
  </svg>
);
const EmailIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        ...
        <FormWrapper>
          <StyledWrapper>
            <form className="form" onSubmit={handleSubmit}>
              <FormHeader><ScalesIcon /><FormTitle>Join the Courtroom</FormTitle><FormSubtitle>Start your legal journey today</FormSubtitle></FormHeader>
              <Divider />
              <FieldGroup><FieldLabel>Full Name</FieldLabel><InputRow><IconWrap><UserIcon /></IconWrap><StyledInput placeholder="Enter your full name" required /></InputRow></FieldGroup>
              <FieldGroup><FieldLabel>College / University</FieldLabel><InputRow><IconWrap><UniversityIcon /></IconWrap><StyledInput placeholder="Enter your college/university" required /></InputRow></FieldGroup>
              ...
              <FieldGroup><FieldLabel>Legal Specialisation</FieldLabel><InputRow><IconWrap><StarIcon /></IconWrap><StyledInput placeholder="Enter your legal specialisation" required /></InputRow></FieldGroup>
              <FieldGroup><FieldLabel>Password</FieldLabel><InputRow><IconWrap><LockIcon /></IconWrap><StyledInput type="password" placeholder="Create a password" required /></InputRow></FieldGroup>
              <SubmitButton type="submit">Create Account</SubmitButton>
              <SignInText>Already have an account?{' '}<InlineLink onClick={() => navigate('/authentication')}>Sign In</InlineLink></SignInText>
              <OrDivider><span>Or continue with</span></OrDivider>
              <GoogleButton type="button" onClick={handleGoogleSignup}><GoogleIcon />Sign up with Google</GoogleButton>
            </form>
          </StyledWrapper>
...
const SignInText = styled.p`text-align: center; font-family: 'EB Garamond', Georgia, serif; font-size: 14px; color: #64748b; margin: 0 0 16px;`;
